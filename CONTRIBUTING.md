Contributing to Cubex-Network
============================

The Cubex-Network project operates an open contributor model where anyone is
...
The following applies to code changes to the Cubex-Network project, and is not to be
confused with overall Cubex-Network Network Protocol consensus changes.

Whether a pull request is merged into Cubex-Network rests with the project merge
...
Patches that change Cubex-Network consensus rules are considerably more involved than
...
Where a patch set proposes to change the Cubex-Network consensus, it must have been
...
The project leader is the release manager for each Cubex-Network release.
