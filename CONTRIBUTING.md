...
The Cub project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *Tests* for changes to the cub unit tests or QA tests
...
The following applies to code changes to the Cub project, and is not to be
confused with overall CUB Network Protocol consensus changes.

Whether a pull request is merged into Cub rests with the project merge
...
Patches that change CUB consensus rules are considerably more involved than
...
Where a patch set proposes to change the CUB consensus, it must have been
...
The project leader is the release manager for each Cub release.
