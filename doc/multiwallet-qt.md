...
In order to support loading of multiple wallets in cub-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cub.cpp.
...
Changes to cub.cpp
----------------------
cub.cpp is the entry point into cub-qt, and as such, will require some minor modifications to provide hooks for
