...
#if defined(NDEBUG)
#error "CUB cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
    ...
    } else if (nHeight > 0 && nHeight <= 3100) {
      nSubsidy = 1 * COIN;
    } else if (nHeight > 3100 && nHeight <= 43200) {
      nSubsidy = 300 * COIN;
    } else if (nHeight > 43200 && nHeight <= 86400) {
      nSubsidy = 150 * COIN;
    } else if (nHeight > 86400 && nHeight <= 129600) {
      nSubsidy = 75 * COIN;
    } else if (nHeight > 129600 && nHeight <= 2102400) {
      nSubsidy = 37 * COIN;
