                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Cubex-Network") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Cubex-Network address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cub: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Cubex-Network"), this);
    aboutAction->setStatusTip(tr("Show information about Cubex-Network"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Cubex-Network"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Cubex-Network addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Cubex-Network addresses"));
    ...
    openAction->setStatusTip(tr("Open a Cubex-Network: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Cubex-Network help message to get a list with possible Cubex-Network command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Cubex-Network client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Cubex-Network network", "", count));
}
...
{
    QString strTitle = tr("Cubex-Network"); // default title
