...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CUB address"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Cub"), this);
    aboutAction->setStatusTip(tr("Show information about Cub"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CUB"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CUB addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CUB addresses"));
    ...
    openAction->setStatusTip(tr("Open a CUB: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Cub help message to get a list with possible CUB command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Cub client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CUB network", "", count));
}
...
{
    QString strTitle = tr("Cub"); // default title
