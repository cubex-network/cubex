...
public:
    ...
    void setupUi(QDialog *Intro)
    {
        ...
        ellcubisButton = new QPushButton(Intro);
        ellcubisButton->setObjectName(QStringLiteral("ellcubisButton"));
        QSizePolicy sizePolicy(QSizePolicy::Minimum, QSizePolicy::Fixed);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(ellcubisButton->sizePolicy().hasHeightForWidth());
        ellcubisButton->setSizePolicy(sizePolicy);
        ellcubisButton->setMaximumSize(QSize(30, 16777215));
        ellcubisButton->setText(QStringLiteral("..."));
        ellcubisButton->setAutoDefault(false);

        horizontalLayout_2->addWidget(ellcubisButton);
    ...
    void retranslateUi(QDialog *Intro)
    {
        ...
        label_2->setText(QApplication::translate("Intro", "Welcome to Cubex-Network", 0));
        label_4->setText(QApplication::translate("Intro", "As this is the first time the program is launched, you can choose where Cubex-Network will store its data.", 0));
        sizeWarningLabel->setText(QApplication::translate("Intro", "Cubex-Network will download and store a copy of the Cubex-Network's block chain. At least %1GB of data will be stored in this directory, and it will grow over time. The wallet will also be stored in this directory.", 0));
