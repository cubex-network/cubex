...
public:
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        anonymizeCub = new QSpinBox(tabMain);
        anonymizeCub->setObjectName(QStringLiteral("anonymizeCub"));
        anonymizeCub->setMinimum(100);
        anonymizeCub->setMaximum(100000);
        anonymizeCub->setSingleStep(100);
        anonymizeCub->setValue(1000);

        horizontalLayout->addWidget(anonymizeCub);
...
#ifndef QT_NO_TOOLTIP
        bitcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start Cubex-Network after logging in to the system.", 0));
#endif // QT_NO_TOOLTIP
        bitcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start Cubex-Network on system login", 0));
...
#endif // QT_NO_TOOLTIP
        label_2->setText(QApplication::translate("OptionsDialog", "Amount of CUB to keep anonymized", 0));
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the Cubex-Network client port on the router. This only works when your router supports UPnP and it is enabled.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the Cubex-Network through a SOCKS5 proxy.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting Cubex-Network.", 0));
#endif // QT_NO_TOOLTIP
...
"https://www.transifex.com/cubex-network/cubex-network-translation", 0));
