...
#ifndef QT_NO_TOOLTIP
        payTo->setToolTip(QApplication::translate("SendCoinsEntry", "The Cubex-Network address to send the payment to", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        messageTextLabel->setToolTip(QApplication::translate("SendCoinsEntry", "A message that was attached to the Cubex-Network: URI which will be stored with the transaction for your reference. Note: This message will not be sent over the Cubex-Network.", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
